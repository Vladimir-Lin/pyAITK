...
class SexualityMembership ( TreeDock                                       ) :
  ...
  def __init__            ( self , parent = None , plan = None             ) :
    ...
    ##########################################################################
    self . ClassTag           = "SexualityMembership"
    self . FetchTableKey      = "SexualityMembership"
    ##########################################################################
  ...
  def stateChanged            ( self , item , column                       ) :
    ...
    VAL   =                   ( uuid , state ,                               )
    ##########################################################################
    self  . Go                ( self . UpdateSexuality , VAL                 )
    ##########################################################################
    return
  ############################################################################
  ...
  def PrepareItem           ( self , UUID , NAME , BRUSH                   ) :
    ...
    ST   = Qt . Unchecked
    ##########################################################################
    if                      ( UUID in self . PeopleSexualities             ) :
      ST = Qt . Checked
    ##########################################################################
    IT   = QTreeWidgetItem  (                                                )
    IT   . setText          ( 0 , NAME                                       )
  ...
  def loading                        ( self                                ) :
    ...
    ##########################################################################
    PEOSEX = self . SEXUALITY . FetchPeopleSexualities ( DB                  )
    self . PeopleSexualities = PEOSEX
    ##########################################################################
    self   . setVacancy              (                                       )
    self   . GoRelax . emit          (                                       )
    self   . ShowStatus              ( ""                                    )
  ...
  def Prepare             ( self                                           ) :
    ...
    return
  ############################################################################
  def UpdateSexuality           ( self , uuid , state                      ) :
    ##########################################################################
    if                          ( state                                    ) :
      ########################################################################
      if                        ( uuid not in self . PeopleSexualities     ) :
        ######################################################################
        self . PeopleSexualities . append ( uuid                             )
      ########################################################################
    else                                                                     :
      ########################################################################
      if                        ( uuid     in self . PeopleSexualities     ) :
        ######################################################################
        self . PeopleSexualities . remove ( uuid                             )
    ##########################################################################
    DB       = self . ConnectDB (                                            )
    if                          ( self . NotOkay ( DB )                    ) :
      return False
    ##########################################################################
    self     . SEXUALITY . LockRelationTable     ( DB                        )
    self     . SEXUALITY . AssignPeopleSexuality ( DB , uuid , state         )
    ##########################################################################
    DB       . UnlockTables     (                                            )
    DB       . Close            (                                            )
    ##########################################################################
