...
class Blood              ( Columns                                         ) :
  ...
  def CountDefaultCrowds      ( self , DB ,            RELATE , UUID       ) :
    ...
    global BLOODREL
    ##########################################################################
    return self . CountCrowds (        DB , BLOODREL , RELATE , UUID         )
  ############################################################################
  ## 人物加入眼睛外形族群
  ############################################################################
  def CrowdJoinBlood  ( self , DB , TABLE , RELATE , UUID , UUIDs          ) :
    ##########################################################################
    global BloodTypeName
    ##########################################################################
    REL = Relation    (                                                      )
    ...
    return
  ############################################################################
  def CrowdJoinDefaultBlood ( self , DB , RELATE , UUID , UUIDs            ) :
    ##########################################################################
    global BLOODREL
    ##########################################################################
    self . CrowdJoinBlood   ( DB , BLOODREL , RELATE , UUID , UUIDs          )
    ##########################################################################
    return
  ############################################################################
  ## 血型名稱轉血型長編號
  ...
  def FetchPeopleBloods      ( self , DB                                   ) :
    ...
    ##########################################################################
    return REL . GetOwners   ( DB       , BLOODREL                           )
  ############################################################################
  def LockRelationTable ( self , DB                                        ) :
    ##########################################################################
    global BLOODREL
    ##########################################################################
    DB . LockWrites     ( [ BLOODREL                                       ] )
    ##########################################################################
    return
  ############################################################################
  def AssignPeopleBloods ( self , DB , SEID , State                        ) :
    ##########################################################################
    global BloodTypeName
    global BLOODREL
    ##########################################################################
    ...
    if                   ( State                                           ) :
      ########################################################################
      REL . Join         ( DB ,           BLOODREL                           )
      ########################################################################
    else                                                                     :
      ########################################################################
      DB  . Query        ( REL . Delete ( BLOODREL                         ) )
    ##########################################################################
    return
  ############################################################################
  ############################################################################
