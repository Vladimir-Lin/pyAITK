...
class Sexuality          ( Columns                                         ) :
  ...
  def PeopleJoinDefaultSexuality ( self , DB , RELATE , UUID , UUIDs       ) :
    ...
    return
  ############################################################################
  def FetchPeopleSexualities ( self , DB                                   ) :
    ##########################################################################
    global SexualityTypeName
    global SEXUALITYREL
    ##########################################################################
    ...
    ##########################################################################
    return REL . GetOwners   ( DB , SEXUALITYREL                             )
  ############################################################################
  def LockRelationTable ( self , DB                                        ) :
    ##########################################################################
    global SEXUALITYREL
    ##########################################################################
    DB . LockWrites     ( [ SEXUALITYREL                                   ] )
    ##########################################################################
    return
  ############################################################################
  def AssignPeopleSexuality ( self , DB , SEID , State                     ) :
    ##########################################################################
    global SexualityTypeName
    global SEXUALITYREL
    ##########################################################################
    ...
    if                      ( State                                        ) :
      ########################################################################
      REL . Join            ( DB ,           SEXUALITYREL                    )
      ########################################################################
    else                                                                     :
      ########################################################################
      DB  . Query           ( REL . Delete ( SEXUALITYREL                  ) )
    ##########################################################################
    return
  ############################################################################
  ############################################################################
