...
class Query ( )                                                              :
  ...
  def SelectFrom ( self , items , table )                                    :
    ...
    return self . Add ( f"select {items} from {T}" )
  ############################################################################
  ## SQL insert into table
  ############################################################################
  def InsertInto ( self , table )                                            :
    T = self . AssureTable ( table )
    return self . Add ( f"insert into {T}" )
  ############################################################################
  ## SQL update
  ############################################################################
  def Update ( self )                                                        :
  ...
  def AddWhereUuid ( self , U )                                              :
    return self . Add ( self . WhereUuid ( U ) )
  ############################################################################
  ## SQL Where Id
  ############################################################################
  def WhereId ( self , U )                                                   :
  ...
  def AddWhereId ( self , U )                                                :
    return self . Add ( self . WhereId ( U ) )
  ############################################################################
  ## SQL values
  ############################################################################
  def Values ( self )                                                        :
  ...
  ############################################################################
  def OrderBy ( self )                                                       :
    return self . Add ( "order by" )
  ############################################################################
  ## SQL Limit
  ############################################################################
  def Limit ( self , start , total )                                         :
    return self . Add ( f"limit {start} , {total}" )
  ############################################################################
  ## 資料庫表格計數
  ############################################################################
