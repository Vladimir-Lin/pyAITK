...
include ($${PWD}/VCF6/VCF6.pri)
include ($${PWD}/VTK/VTK.pri)
include ($${PWD}/VTK6/VTK6.pri)
include ($${PWD}/Telecom/Telecom.pri)
include ($${PWD}/Conductions/Conductions.pri)
include ($${PWD}/Measure/Measure.pri)
include ($${PWD}/Physics/Physics.pri)
include ($${PWD}/Finance/Finance.pri)
include ($${PWD}/Biology/Biology.pri)
include ($${PWD}/Linguistics/Linguistics.pri)
