...
class PlayList             ( TreeDock                                      ) :
  ...
  def BackgroundStartUp                   ( self                           ) :
    ...
    ##########################################################################
    self   . Listings   =                 [                                  ]
    FLISTs              = LoadJson        ( FPLI                             )
    self   . IDCs       = LoadJson        ( FIDC                             )
    self   . SIGNATUREs =                 [                                  ]
    ##########################################################################
    for JFI in FLISTs                                                        :
      ########################################################################
      FILM = self . QueryFilm             ( JFI                              )
      SIG  = FILM                         [ "Signature"                      ]
      self . Listings   . append          ( FILM                             )
      self . SIGNATUREs . append          ( SIG                              )
      ########################################################################
      self . appendFilm . emit            ( FILM                             )
    ##########################################################################
    self   . LMutex . release             (                                  )
    ##########################################################################
  ...
  def startup ( self                                                       ) :
    ##########################################################################
    self . Go ( self . BackgroundStartUp                                     )
    ##########################################################################
    return
  ############################################################################
  def Closing ( self                                                       ) :
