...
class Panel              ( Widget                                          ) :
  ...
  def Configure                      ( self                                ) :
    ...
    self . MWin      . hide          (                                       )
    ##########################################################################
    AICO             = QIcon         ( ":/images/player-analysis-picture.png"              )
    ...
    self . Analysis  . hide          (                                       )
    ##########################################################################
    DICO             = QIcon         ( ":/images/player-picture-editor.png"  )
    ...
    self . Drawing   . hide          (                                       )
    ##########################################################################
    WICO             = QIcon         ( ":/images/player-prev-frame.png"      )
    self . PrevFrame = QPushButton   ( WICO , "" , self                      )
    self . PrevFrame . setIconSize   ( QSize ( 20 , 20                     ) )
    self . PrevFrame . setFlat       ( True                                  )
    self . PrevFrame . setEnabled    ( True                                  )
    self . PrevFrame . setCheckable  ( True                                  )
    self . PrevFrame . hide          (                                       )
    ##########################################################################
    XICO             = QIcon         ( ":/images/player-next-frame.png"      )
    self . NextFrame = QPushButton   ( XICO , "" , self                      )
    self . NextFrame . setIconSize   ( QSize ( 20 , 20                     ) )
    self . NextFrame . setFlat       ( True                                  )
    self . NextFrame . setEnabled    ( True                                  )
    self . NextFrame . setCheckable  ( True                                  )
    self . NextFrame . hide          (                                       )
    ##########################################################################
    VICO             = QIcon         ( ":/images/Menu.png"                   )
    self . VMenu     = QPushButton   ( VICO , "" , self                      )
  ...
  def Relocation                   ( self                                  ) :
    ...
    self . PrevFrame . setGeometry (     280 , 24 ,  20 , 20                 )
    self . NextFrame . setGeometry (     280 , 44 ,  20 , 20                 )
    ##########################################################################
    self . FineTune  . setGeometry (       0 , 64 ,   W , 16                 )
    ##########################################################################
    if ( self . DeltaEditor not in [ False , None ]                        ) :
      ########################################################################
      self . DeltaEditor . setGeometry ( 320 , 24 ,  120 , 24                )
    ##########################################################################
    return
  ############################################################################
