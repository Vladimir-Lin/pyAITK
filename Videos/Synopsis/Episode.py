...
class Episode    (                                                         ) :
  ...
  def ScanAlbumDocuments ( self                                            ) :
    ...
    if                   ( PPP . is_file (                               ) ) :
      ########################################################################
      self . Album [ "Documents" ] [ "Head" ] = FFF
    ##########################################################################
    ## 字幕製作批次檔
    ##########################################################################
    FFF  = "scripts/Subtitles.bat"
    SSS  = f"{DDD}/{FFF}"
    ##########################################################################
    PPP  = Path          ( SSS                                               )
    ##########################################################################
    if                   ( PPP . is_file (                               ) ) :
      ########################################################################
      self . Album [ "Documents" ] [ "Subtitles" ] = FFF
    ##########################################################################
    ## 影集整體描述
    ##########################################################################
  ...
  def ScanAlbumIdentifiers   ( self , DB                                   ) :
    ...
    return
  ############################################################################
  def ScanAlbumDescriptions  ( self , DB                                   ) :
    ##########################################################################
    self   . logMessage      ( "ScanDescriptions..."                         )
    ##########################################################################
    NOXTAB = self . Tables   [ "SmartNote" ] [ "Notes"                       ]
    UUID   = self . Uuid
    ##########################################################################
    QQ     = f"""select `note` from {NOXTAB}
                 where ( `uuid` = {UUID} )
    ...
    ##########################################################################
    try                                                                      :
      with open              ( PPP , 'w' , encoding = "utf-8" ) as f         :
        f . write            ( SDOC                                          )
    except                                                                   :
      pass
    ##########################################################################
