...
class Ui_EpisodeEstablish(object):
    def setupUi(self, EpisodeEstablish):
        ...
        self.NotReady = QLabel(EpisodeEstablish)
        self.NotReady.setObjectName(u"NotReady")
        self.NotReady.setGeometry(QRect(12, 12, 380, 28))
        self.NotReady.setAlignment(Qt.AlignCenter)
        ...
        self.Scanning = QLabel(EpisodeEstablish)
        self.Scanning.setObjectName(u"Scanning")
        self.Scanning.setGeometry(QRect(10, 46, 380, 28))
        self.Scanning.setAlignment(Qt.AlignCenter)
    ...
    def retranslateUi(self, EpisodeEstablish):
        ...
        self.NotReady.setText(QCoreApplication.translate("EpisodeEstablish", u"\u5f71\u96c6\u57fa\u672c\u8cc7\u8a0a\u5c1a\u672a\u5efa\u7acb\uff0c\u662f\u5426\u958b\u59cb\u9032\u884c\u76ee\u9304\u6383\u63cf\uff1f", None))
#if QT_CONFIG(tooltip)
        ...
        self.Scanning.setText(QCoreApplication.translate("EpisodeEstablish", u"\u6383\u63cf\u5f71\u96c6\u76ee\u9304\u8cc7\u8a0a\u4e2d\u2026", None))
    # retranslateUi
