...
class CliParser  (                                                         ) :
  ...
  def FindPeopleByName      ( self                                         ) :
    ...
    R       = self . CLI    [ KEY ] [ "Relation"                             ]
    ##########################################################################
    HMSG    = self . Translations [ "CMD::People::Search:"                   ]
    MLOG    = f"{HMSG}{NAME}"
    self    . LOG           ( MLOG                                           )
    ##########################################################################
    LNAME   = NAME . lower  (                                                )
    ...
    if                      ( ALL in [ False , None ]                      ) :
      return
    ##########################################################################
    MSG     = self . Translations [ "CMD::People::Found"                     ]
    UUIDs   =               [                                                ]
    UUIDz   =               [ MSG                                            ]
    ##########################################################################
    for R in ALL                                                             :
    ...
    if                      ( len ( UUIDs ) <= 0                           ) :
      ########################################################################
      MSG   = self . Translations [ "CMD::People::NotFound"                  ]
      self  . LOG           ( MSG                                            )
      ########################################################################
      return
    ##########################################################################
  ...
  def FindOrganizationByName ( self                                        ) :
    ...
    if                      ( ALL in [ False , None ]                      ) :
      return
    ##########################################################################
    MSG     = self . Translations [ "CMD::Organization::Found"               ]
    UUIDs   =               [                                                ]
    UUIDz   =               [ MSG                                            ]
    ##########################################################################
    for R in ALL                                                             :
    ...
    if                      ( len ( UUIDs ) <= 0                           ) :
      ########################################################################
      MSG   = self . Translations [ "CMD::Organization::NotFound"            ]
      self  . LOG           ( MSG                                            )
      ########################################################################
      return
    ##########################################################################
