...
class CliParser  (                                                         ) :
  ...
  def FindAllEpisodeByName  ( self                                         ) :
    ...
    if                      ( len ( UUIDs ) <= 0                           ) :
      ...
      return
    ##########################################################################
    sorted                  ( UUIDs , reverse = True                         )
    sorted                  ( UUIDz , reverse = True                         )
    ##########################################################################
    MSG     = "\n" . join   ( UUIDz                                          )
    self    . LOG           ( MSG                                            )
    ##########################################################################
  ...
  def FindEpisodeNoName     ( self                                         ) :
    ...
    return
  ############################################################################
  def FindAllEpisodeByIdentifier ( self                                    ) :
    ##########################################################################
    KEY     = "Episode"
    ##########################################################################
    self    . CLI           [ "Action" ] = ""
    ...
    return
  ############################################################################
  def FindAllEpisodeByIdentifiers ( self                                   ) :
    ##########################################################################
    KEY     = "Episode"
    ##########################################################################
    self    . CLI           [ "Action" ] = ""
    ...
    ##########################################################################
    ALL     =               [                                                ]
    HMSG    = self . Translations   [ f"CMD::{KEY}::Identifier:"             ]
    ##########################################################################
    for NAME in NAMEs                                                        :
      ########################################################################
      MLOG  = f"{HMSG}{NAME}"
  ...
  def decodeSearchEpisode               ( self , cmd , sequences           ) :
    ...
    if                                  ( T > 1                            ) :
      ...
      if                                ( token in EM                      ) :
        ...
        return
      ########################################################################
      EM          = self . Translations [ "CMD::Key::Identifiers"            ]
      ########################################################################
      if                                ( token in EM                      ) :
        ######################################################################
        if                              ( T > 2                            ) :
          ...
          if                            ( tkn in BM                        ) :
            ...
            if                          ( T > 3                            ) :
              ...
              if                        ( NN in NM                         ) :
                ##############################################################
                threading . Thread      ( target = self . FindAllEpisodeByIdentifiers ) \
                          . start       (                                    )
                ##############################################################
                return
          ####################################################################
        ...
        ######################################################################
        ######################################################################
        threading . Thread              ( target = self . FindAllEpisodeByIdentifier ) \
                  . start               (                                    )
        ######################################################################
        return
    ##########################################################################
