...
class VideoListings               ( TreeDock                               ) :
  ...
  def PrepareForActions           ( self                                   ) :
    ...
    ##########################################################################
    self . AppendSideActionWithIcon ( "UpdateFilmDetails"                  , \
                                      ":/images/videogroup.png"            , \
                                      self . UpdateFilmDetails               )
    ##########################################################################
    return
  ############################################################################
  ...
  def GroupsMenu                ( self , mm , item                         ) :
    ...
    ##########################################################################
    msg  = self . getMenuItem   ( "UpdateFilmDetails"                        )
    icon = QIcon                ( ":/images/videogroup.png"                  )
