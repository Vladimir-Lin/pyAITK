...
class Recognizer (                                                         ) :
  ...
  def DecodeDlib68Landmarks ( self , shape                                 ) :
    ...
    ##########################################################################
    MCX       = Landmarks   [ "Mouth"  ] [ "OuterRect" ] [ "CX"              ]
    MCY       = Landmarks   [ "Mouth"  ] [ "OuterRect" ] [ "CY"              ]
    ##########################################################################
    dX        = int         ( T [ 0 ] - MCX                                  )
    dY        = int         ( T [ 1 ] - MCY                                  )
    ##########################################################################
    ...
    ROTA      =             ( ANGLE - 270.0                                  )
    ##########################################################################
    Landmarks [ "Face" ] [ "Angle"  ] = ANGLE
    Landmarks [ "Face" ] [ "Rotate" ] = ROTA
    Landmarks [ "Face" ] [ "Axis"   ] = [ T , [ MCX , MCY ]                  ]
    ##########################################################################
