...
class PeopleMeasureEditor ( TreeDock                                       ) :
    ...
    for ITEM in ITEMs                                                        :
      ...
      if                                ( "Weight" == ITEM                 ) :
        ...
        if                              ( OK                               ) :
          ...
          IMP = f"{V}"
        ######################################################################
      elif                              ( "Measure-Counts" == ITEM         ) :
        ######################################################################
        if                              ( OK                               ) :
          ####################################################################
          VX  = self . toMetricLength   ( V                                  )
          VV  = int                     ( float ( VX )                       )
          VS  = f"{VV}"
          IMP = VS
        ######################################################################
  ...
  def StartupPeople ( self , uuid                                          ) :
    ...
    return
  ############################################################################
  def WaitRefreshItems               ( self                                ) :
    ##########################################################################
    time . sleep                     ( 1.0                                   )
    LL   = self . CovertMeasureItems (                                       )
    self . emitAllNames . emit       ( LL                                    )
    ##########################################################################
    return
  ############################################################################
      ...
      if                               ( 3 == len ( MTL )                  ) :
        ...
        if                             ( "Bust"  not in self . MEASURE     ) :
          ...
          try                                                                :
            ...
            VZ = int                   ( WZ * 2540                           )
            ##################################################################
            self . MEASURE [ "Bust"  ] = VZ
            ##################################################################
          except                                                             :
            pass
        ######################################################################
        if                             ( "Waist" not in self . MEASURE     ) :
          ####################################################################
          try                                                                :
            ##################################################################
            BV = MTL                   [ 1                                   ]
            ...
            VZ = int                   ( WZ * 2540                           )
            ##################################################################
            self . MEASURE [ "Waist" ] = VZ
            ##################################################################
          except                                                             :
            pass
        ######################################################################
        if                             ( "Hip"   not in self . MEASURE     ) :
          ####################################################################
          try                                                                :
            ##################################################################
            BV = MTL                   [ 2                                   ]
