...
class Face                  (                                              ) :
  ...
  def ToSquareRectangle           ( self , rect                            ) :
    ...
    return self . CreateRectangle ( x , y , w , h                            )
  ############################################################################
  def ToSquareRestraint              ( self , rect , ratio                 ) :
    ##########################################################################
    KRQ  = self . ScaleRectangle     (        rect , ratio                   )
    KQQ  = self . ToSquareRectangle  ( KRQ                                   )
    ##########################################################################
    return self . RestraintRectangle ( self . Full , KQQ                     )
  ############################################################################
