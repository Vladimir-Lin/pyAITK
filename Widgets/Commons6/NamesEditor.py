...
class NamesEditor          ( TreeDock , NameItem                           ) :
  ...
  def PrepareForActions                    ( self                          ) :
    ...
    self . AppendSideActionWithIcon        ( "QuickAdd"                    , \
                                             ...
                                             True                          , \
                                             False                           )
    self . AppendSideActionWithIcon        ( "FillAdd"                     , \
  ...
  def CopyAllToClipboard                ( self                             ) :
    ...
    for ait in range                    ( 0 , TOTAL                        ) :
      ...
      NAMEz . append                    ( JSON                               )
    ##########################################################################
    ZJSON   =                           { "Usage"    : self . ClassTag     , \
                                          "Listings" : NAMEz                 }
    DJSON   = json . dumps              ( ZJSON                              )
  ...
  def CopyAllFromClipboard                  ( self                         ) :
    ...
    ##########################################################################
    VAL      =                              ( JL ,                           )
    self     . Go                           ( self . JsonToDatabase , VAL    )
    ##########################################################################
    return
  ############################################################################
  ...
  def TranslateMenu                ( self , mm                             ) :
    ...
    return mm
  ############################################################################
  def TsTranslation                    ( self , item , LID                 ) :
    ##########################################################################
  ...
  def DoTsTranslate              ( self                                    ) :
    ...
    if                           ( 1 != len ( items )                      ) :
      return
    ##########################################################################
    self  . TsTranslation        ( items [ 0 ] , 7001                        )
    ##########################################################################
    return
  ############################################################################
  ...
  def Menu                            ( self , pos                         ) :
    ...
    mm     . addActionWithIcon        ( 2003 , icon , msg                    )
    ##########################################################################
    if                                ( len ( items ) > 0                  ) :
