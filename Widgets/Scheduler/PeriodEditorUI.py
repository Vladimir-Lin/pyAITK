...
class Ui_PeriodEditorUI(object):
    def setupUi(self, PeriodEditorUI):
        ...
        self.StartTime.dateTimeChanged['QDateTime'].connect(PeriodEditorUI.StartTimeChanged)
        self.FinishTime.dateTimeChanged['QDateTime'].connect(PeriodEditorUI.FinishTimeChanged)
