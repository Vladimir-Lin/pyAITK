...
class Ui_PeriodEditorUI(object):
    def setupUi(self, PeriodEditorUI):
        ...
        self.ItemSpin.setGeometry(QtCore.QRect(120, 100, 200, 28))
        ...
        self.StatesLabel.setGeometry(QtCore.QRect(340, 100, 80, 28))
        self.StatesLabel.setObjectName("StatesLabel")
        self.StatesBox = QtWidgets.QComboBox(PeriodEditorUI)
        self.StatesBox.setGeometry(QtCore.QRect(420, 100, 200, 28))
