...
class PeopleView                     ( IconDock                            ) :
  ...
  def GroupsMenu               ( self , mm , uuid , item                   ) :
    ...
    mm  . addActionFromMenu    ( LOM , 24231215 , MSG                        )
    ##########################################################################
    MSG = self . getMenuItem   ( "Eyes"                                      )
    mm  . addActionFromMenu    ( LOM , 24231216 , MSG                        )
    ##########################################################################
    MSG = self . getMenuItem   ( "Iris"                                      )
    mm  . addActionFromMenu    ( LOM , 24231217 , MSG                        )
    ##########################################################################
    MSG = self . getMenuItem   ( "Nose"                                      )
    mm  . addActionFromMenu    ( LOM , 24231218 , MSG                        )
    ##########################################################################
    MSG = self . getMenuItem   ( "Tits"                                      )
    mm  . addActionFromMenu    ( LOM , 24231219 , MSG                        )
    ##########################################################################
    MSG = self . getMenuItem   ( "Umbilicus"                                 )
    mm  . addActionFromMenu    ( LOM , 24231220 , MSG                        )
    ##########################################################################
    ...
    mm  . addActionFromMenu    ( LOM , 24231231 , MSG                        )
    ##########################################################################
    mm  . addSeparatorFromMenu ( LOM                                         )
    ##########################################################################
    MSG = self . getMenuItem   ( "WebPages"                                  )
    mm  . addActionFromMenu    ( LOM , 24231241 , MSG                        )
    ##########################################################################
    MSG = self . getMenuItem   ( "IdentWebPage"                              )
    mm  . addActionFromMenu    ( LOM , 24231242 , MSG                        )
    ##########################################################################
    return mm
  ############################################################################
