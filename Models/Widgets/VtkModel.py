...
class VtkModel                 ( VtkWidget                                 ) :
  ...
  def PrepareForJSON              ( self                                   ) :
    ...
    while                         ( AT < TOTAL                             ) :
      ...
      ########################################################################
      self . CreateActorFromJson  ( self , ACT                               )
      ########################################################################
      AT   = AT + 1
    ##########################################################################
  ...
  def DataToEdges                 ( self , DS                              ) :
    ...
    while                         ( SAT < CETS                             ) :
      ########################################################################
      EE  = self . CellToEdges    ( DS . GetCell ( SAT )                     )
      FF  . append                ( EE                                       )
      ########################################################################
      SAT = SAT + 1
    ##########################################################################
  ...
  def ActorToJSON              ( self , actor                              ) :
    ...
    vi  = vm    . GetInput     (                                             )
    ##########################################################################
    PTS = self  . DataToPoints ( vi                                          )
    FAC = self  . DataToEdges  ( vi                                          )
    ##########################################################################
    return                     { "TotalPoints" : len ( PTS )               , \
                                 "TotalFaces"  : len ( FAC )               , \
                                 "Points"      : PTS                       , \
                                 "Faces"       : FAC                         }
  ############################################################################
