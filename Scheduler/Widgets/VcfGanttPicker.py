...
class VcfGanttPicker              ( VcfCanvas                              ) :
  ...
  def CalibrateTimeAlign      ( self , T                                   ) :
    ...
    BASE = int                ( T - SOD                                      )
    ##########################################################################
    if                        ( self . TimeAlignment == 1                  ) :
      ########################################################################
      MM = int                ( SOD % 60                                     )
      ########################################################################
      return int              ( T - MM                                       )
    ##########################################################################
    if                        ( self . TimeAlignment == 2                  ) :
      ########################################################################
      MM = int                ( SOD % 3600                                   )
      ########################################################################
      return int              ( T - MM                                       )
    ##########################################################################
    if                        ( self . TimeAlignment == 3                  ) :
      return BASE
    ##########################################################################
    return T
  ############################################################################
  def TickToString            ( self , DT                                  ) :
    ##########################################################################
    SS   = self . getMenuItem ( "Seconds"                                    )
    MM   = self . getMenuItem ( "Minutes"                                    )
    HH   = self . getMenuItem ( "Hours"                                      )
    DD   = self . getMenuItem ( "Days"                                       )
    ##########################################################################
    MV   = int                ( DT / 60                                      )
    SV   = int                ( DT % 60                                      )
    HV   = int                ( MV / 60                                      )
