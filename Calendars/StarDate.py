...
##############################################################################
## 1970-01-01 00:00:00 1420092377704080000
##    1-01-01 00:00:00 1420092315568483200
##############################################################################
class StarDate (                                                           ) :
  ############################################################################
  def __init__ ( self                                                      ) :
  ...
  ############################################################################
  def toMPFR    ( self                                                     ) :
    return mpfr ( self . Stardate , 1024                                     )
  ############################################################################
  ## 轉換到J2000
  ############################################################################
  def toJ2000    ( self                                                    ) :
  ...
  def toSiderealDay ( self                                                 ) :
    return float    ( self . toJ2000 ( ) / 86164.098903691                   )
  ############################################################################
  ## J2000轉換到恆星年單位
  ## 31558149.54
  ## 31558149.7635456
  ...
  ############################################################################
  def TzDiff                     ( self , TZ1 , TZ2                        ) :
    ##########################################################################
    self   . Now                 (                                           )
    DS     = self . toDateString ( TZ1 , "%Y-%m-%d"                          )
    DF     = f"{DS}T00:00:00"
    ##########################################################################
    self   . fromInput           ( DF , TZ1                                  )
    DT1    = self . Stardate
    ##########################################################################
    self   . fromInput           ( DF , TZ2                                  )
    DT2    = self . Stardate
    ##########################################################################
    return int                   ( DT1 - DT2                                 )
  ############################################################################
