...
class HoloceneFormatter  ( Formatter                                       ) :
  ...
  def heToWeekdays                ( self , Calendar , Format               ) :
    ##########################################################################
    WX = Calendar . WeekDays      [ Calendar . WEEKDAY                       ]
    WS = Calendar . ShortWeekDays [ Calendar . WEEKDAY                       ]
    ##########################################################################
    KV =                          { "%(W)"  : WX                           , \
                                    "%(WL)" : WX                           , \
                                    "%(WS)" : WS                             }
  ...
  def heToTimeZone             ( self , Calendar , Format                  ) :
    return self . ReplacePairs ( { "%(TZ)" : Calendar . TimeZone } , Format  )
  ############################################################################
...
class Holocene                   ( Base                                    ) :
  ...
  def isLeapYear               ( self                                      ) :
    ##########################################################################
    return self . heIsLeapYear ( self . YEAR                                 )
  ############################################################################
  ...
  def heToSdRule3             ( self , YEARS , MONTHS , DAY                ) :
    ...
    ##########################################################################
    BYEAR = int               ( - QY                                         )
    BASE  = int               ( 1420091999968204800 - QT                     )
    ##########################################################################
