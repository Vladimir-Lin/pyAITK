...
class Holocene                   ( Base                                    ) :
  ...
  def __init__                   ( self                                    ) :
    ...
    ##########################################################################
    self      . setFormat        ( "%HE %YYYY/%MM/%DD %hh:%mm:%ss"           )
  ...
  def heLeapMonthDate      ( self , DAYS                                   ) :
    ...
    return                 ( M , D ,                                         )
  ############################################################################
  def NoLeapMonthDate1582      ( self , DAYS                               ) :
    ##########################################################################
  ...
  def toHoloceneYNDHMS             ( self , CDT                            ) :
    ...
    ##########################################################################
    elif                           ( CDT >=        1420092315537724800     ) :
      return self . heLeap400Rule1 ( CDT ,     0 , 1420092315537724800       )
    ##########################################################################
    return   self . heLeap400Rule2 ( CDT ,     0 , 1420092315537724800       )
  ############################################################################
  def heToSdNoLeapYear        ( self                                       , \
    ...
    if                        ( MX < 0                                     ) :
      ...
      MX = 11
    ##########################################################################
    MB   = self . NonLeapYear [ D                                            ]
    ME   = self . NonLeapYear [ D + 1                                        ]
    ##########################################################################
    MT   = int                ( MB + DAY - 1                                 )
    ##########################################################################
    if                        ( MT < MB                                    ) :
  ...
  def heToSdRule2                  ( self , YEARS , MONTHS , DAY           ) :
    return self . heToSdLeap4Rule1 ( YEARS                                 , \
                                     MONTHS                                , \
                                     DAY                                   , \
                                     11584                                 , \
                                     1420092365523062400                     )
